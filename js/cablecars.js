...
// set localstorage
let jsoncable = JSON.stringify(cablecarss);
console.log(jsoncable);
localStorage.setItem(
  "THEMESIMG",
  `[
    { CABLECARS: ${jsoncable}, cabledesc: ${cabledesc} },
  ]}`
);
...
let cablecarslocal = JSON.parse(localStorage.getItem("THEMESIMG"));

// console.log(cablecarslocal[0].CABLECARS);

cablecarslocal.forEach((value, index) => {
  // console.log(value.CABLECARS.length);
  value.CABLECARS.forEach((val, inx) => {
    // console.log(value.CABLECARS[inx].img);
    ...
    img.src = value.CABLECARS[inx].img;
    cardtxtdiv.className = "cardtxt";
    h4.innerHTML = value.CABLECARS[inx].country;
    h2.innerHTML = value.CABLECARS[inx].location;
    ptag.innerHTML = value.CABLECARS[inx].description;
